// Node.js High-Precision Scheduler - Voucher 3
...
const CONFIG = {
    ...
    payload: {
        voucher_promotionid: 1206237979754498, // Different voucher ID for voucher 3
        signature: "z9y8x7w6v5u4t3s2r1q0p9o8n7m6l5k4j3i2h1g0f9e8d7c6b5a4z3y2x1w0v9u8", // Different signature
        signature_source: "0"
    }
};
...
function main() {
    ...
    if (args.includes('--once')) {
        ...
        console.log(`  node voucher_3_scheduler.js --once [--time=HH:MM:SS]    # Jalankan sekali pada waktu tertentu`);
        console.log(`  node voucher_3_scheduler.js --daily [--time=HH:MM:SS]   # Schedule harian pada waktu tertentu`);
        console.log(`  node voucher_3_scheduler.js --test                      # Test request sekarang`);
        console.log('');
        console.log('Contoh:');
        console.log(`  node voucher_3_scheduler.js --once                      # Default 20:00:00`);
        console.log(`  node voucher_3_scheduler.js --once --time=14:30:15      # Custom 14:30:15`);
        console.log(`  node voucher_3_scheduler.js --once --time=14:30         # Custom 14:30:00`);
        process.exit(1);
    }
}
